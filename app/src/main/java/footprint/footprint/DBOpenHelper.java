...
public class DBOpenHelper extends SQLiteOpenHelper {
    ...
    public void onCreate(SQLiteDatabase db) {
        ...
        String footprintTable = "CREATE TABLE IF NOT EXISTS footprint (" +
        ...
        String polylineTable = "CREATE TABLE IF NOT EXISTS polyline (" +
                "_id integer not null primary key autoincrement, " +
                "date text," +
                "latitude real," +
                "longitude real);";

        db.execSQL(footprintTable);
        db.execSQL(polylineTable);
    ...
    public void onUpgrade(SQLiteDatabase db, int oldVersion, int newVersion) {
        ...
        String sql = "drop table if exists footprint";
        db.execSQL(sql);
